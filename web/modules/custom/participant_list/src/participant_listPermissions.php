...
use Drupal\participant_list\Entity\participant_listType;


/**
 * Provides dynamic permissions for Participant of different types.
 *
 * @ingroup participant_list
 *
 */
class participant_listPermissions{
   ...
   *
   * @return array
   *   The participant_list by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (participant_listType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\participant_list\Entity\participant_listType $type
   *   The participant_list type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(participant_listType $type) {
    $type_id = $type->id();
